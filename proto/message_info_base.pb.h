...
PROTOBUF_NAMESPACE_OPEN
template<> ::raybo::MessageInfoBase* Arena::CreateMaybeMessage<::raybo::MessageInfoBase>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace raybo {
...
class MessageInfoBase final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:raybo.MessageInfoBase) */ {
 public:
  inline MessageInfoBase() : MessageInfoBase(nullptr) {}
  ~MessageInfoBase() override;
  explicit PROTOBUF_CONSTEXPR MessageInfoBase(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  // @@protoc_insertion_point(class_scope:raybo.MessageInfoBase)
 private:
  class _Internal;
...
inline uint32_t MessageInfoBase::_internal_ver() const {
  return _impl_.ver_;
}
inline uint32_t MessageInfoBase::ver() const {
  // @@protoc_insertion_point(field_get:raybo.MessageInfoBase.ver)
  return _internal_ver();
}
inline void MessageInfoBase::_internal_set_ver(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.ver_ = value;
}
inline void MessageInfoBase::set_ver(uint32_t value) {
  _internal_set_ver(value);
  // @@protoc_insertion_point(field_set:raybo.MessageInfoBase.ver)
}
...
inline uint32_t MessageInfoBase::_internal_message_id() const {
  return _impl_.message_id_;
}
inline uint32_t MessageInfoBase::message_id() const {
  // @@protoc_insertion_point(field_get:raybo.MessageInfoBase.message_id)
  return _internal_message_id();
}
inline void MessageInfoBase::_internal_set_message_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.message_id_ = value;
}
inline void MessageInfoBase::set_message_id(uint32_t value) {
  _internal_set_message_id(value);
  // @@protoc_insertion_point(field_set:raybo.MessageInfoBase.message_id)
}

// optional uint32 publisher_id = 3;
inline bool MessageInfoBase::_internal_has_publisher_id() const {
...
inline uint32_t MessageInfoBase::_internal_publisher_id() const {
  return _impl_.publisher_id_;
}
inline uint32_t MessageInfoBase::publisher_id() const {
  // @@protoc_insertion_point(field_get:raybo.MessageInfoBase.publisher_id)
  return _internal_publisher_id();
}
inline void MessageInfoBase::_internal_set_publisher_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.publisher_id_ = value;
}
inline void MessageInfoBase::set_publisher_id(uint32_t value) {
  _internal_set_publisher_id(value);
  // @@protoc_insertion_point(field_set:raybo.MessageInfoBase.publisher_id)
}
...
inline uint32_t MessageInfoBase::_internal_publish_time() const {
  return _impl_.publish_time_;
}
inline uint32_t MessageInfoBase::publish_time() const {
  // @@protoc_insertion_point(field_get:raybo.MessageInfoBase.publish_time)
  return _internal_publish_time();
}
inline void MessageInfoBase::_internal_set_publish_time(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.publish_time_ = value;
}
inline void MessageInfoBase::set_publish_time(uint32_t value) {
  _internal_set_publish_time(value);
  // @@protoc_insertion_point(field_set:raybo.MessageInfoBase.publish_time)
}
...
inline const std::string& MessageInfoBase::content() const {
  // @@protoc_insertion_point(field_get:raybo.MessageInfoBase.content)
...
void MessageInfoBase::set_content(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.content_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:raybo.MessageInfoBase.content)
}
inline std::string* MessageInfoBase::mutable_content() {
  std::string* _s = _internal_mutable_content();
  // @@protoc_insertion_point(field_mutable:raybo.MessageInfoBase.content)
  return _s;
}
...
inline std::string* MessageInfoBase::release_content() {
  // @@protoc_insertion_point(field_release:raybo.MessageInfoBase.content)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:raybo.MessageInfoBase.content)
}
